            ...
            child: Padding(
              ...
              child: Text(widget.note,
                  style: GoogleFonts.inter(
                      fontSize: 10.5, color: widget.color, height: 1.5)),
            ),
          ),
        ),
      ),
          ...
          children: [
            ...
            Container(
                ...
                decoration: BoxDecoration(
                    shape: BoxShape.circle,
                    border: Border.all(
                        color: widget.color.withOpacity(r2op), width: 1.5))),
            Container(
                width: r1sz,
                height: r1sz,
                decoration: BoxDecoration(
                    shape: BoxShape.circle,
                    border: Border.all(
                        color: widget.color.withOpacity(r1op), width: 2))),
            Container(
                width: widget.size,
                height: widget.size,
                decoration: BoxDecoration(
                ...
                child: Icon(widget.icon,
                    size: widget.size * 0.5, color: widget.color)),
          ],
        );
      },
    );
...
class _MainPageState extends State<MainPage> with TickerProviderStateMixin {
                    ...
                    PressScale(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                                color: t.border.withOpacity(0.9), width: 0.8),
                            boxShadow: [
                              BoxShadow(
                                  color: Colors.black
                                      .withOpacity(t.isDark ? 0.24 : 0.05),
                                  blurRadius: 14,
  ...
  Widget _navItem(
      IconData icon, String label, int idx, WorkoutTheme t, double w) {
    final sel = idx == _tab;
    return Expanded(
...
class _DaySegmentedNav extends StatelessWidget {
  ...
  const _DaySegmentedNav(
      {required this.selected, required this.theme, required this.onSelect});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
            color: t.border.withOpacity(t.isDark ? 0.8 : 0.72), width: 0.8),
        boxShadow: [
          BoxShadow(
...
class _WorkoutPageState extends State<WorkoutPage> {
        ...
        child: Container(
          ...
          child: Padding(
              ...
              child: Column(
                ...
                children: [
                  _PulseIcon(
                      icon: Icons.bedtime_rounded, size: 64, color: t.primary),
                  ...
                  _restTip(
                      Icons.dark_mode_rounded, '保证 7-9 小时睡眠', t.primary, t),
              ...
              ClipRRect(
                  ...
                  child: TweenAnimationBuilder<double>(
                    ...
                    builder: (_, v, __) => LinearProgressIndicator(
                        ...
                        minHeight: 7,
                        backgroundColor:
                            t.border.withOpacity(t.isDark ? 0.7 : 0.9),
                        valueColor: AlwaysStoppedAnimation(t.success)),
                  )),
            ])),
        const SizedBox(height: 14),
        ...day.exercises.asMap().entries.map((e) => FadeScaleEntry(
            index: e.key + 2,
            child: _exCard(
              e.value,
              e.key + 1,
  ...
  Widget _exCard(
      Exercise ex, int num, bool done, WorkoutTheme t, VoidCallback tap) {
        ...
        child: Card(
          ...
          shape: RoundedRectangleBorder(
              ...
              side: done
                  ...
                  : (ex.isStar
                      ? BorderSide(
                          color: t.primary.withOpacity(0.26), width: 1.2)
                      : BorderSide(
                          color: t.border.withOpacity(0.9), width: 0.8))),
          child: Padding(
              padding: const EdgeInsets.all(14),
                ...
                PressScale(
                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                          ...
                          border: Border.all(
                              color: done ? t.success : t.border, width: 1.4),
                          boxShadow: done
                              ? [
                                  BoxShadow(
                                      color: t.success.withOpacity(0.28),
                    ...
                    child: Column(
                      ...
                      Wrap(spacing: 4, runSpacing: 2, children: [
                        ...
                        if (ex.muscleTarget.isNotEmpty)
                          Text(ex.muscleTarget,
                              style: GoogleFonts.inter(
                                  fontSize: 9, color: t.text3)),
                      ]),
                      if (ex.note != null)
                        AnimatedNote(
                            note: ex.note!, visible: !done, color: t.text3),
                      if (recent != null) ...[
  ...
  Future<void> _recordExercise(Exercise exercise) async {
    ...
    final setsCtrl =
        TextEditingController(text: '${latest?.sets ?? exercise.sets}');
...
class _RecordPageState extends State<RecordPage> {
                ...
                children: [
                  ...
                  PressScale(
                      ...
                      child: Column(children: [
                        Text('$_viewYear年 ${monthNames[_viewMonth - 1]}',
                            style: GoogleFonts.inter(
                                fontSize: 16,
                                fontWeight: FontWeight.w800,
                                color: t.text1)),
              ...
              child: FadeScaleEntry(
                  ...
                  child: Card(
                    ...
                    child: Column(children: [
                      ...
                      const SizedBox(height: 6),
                      ..._buildCalendarRows(
                          daysInMonth, firstWeekday, now, isCurrentMonth, t),
                      const SizedBox(height: 10),
                      Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
  ...
  List<Widget> _buildCalendarRows(int daysInMonth, int firstWeekday,
      DateTime now, bool isCurrentMonth, WorkoutTheme t) {
    final rows = <Widget>[];
    int day = 1;
            ...
            child: SizedBox(
              ...
              child: Center(
                ...
                decoration: BoxDecoration(
                  ...
                  border:
                      isToday ? Border.all(color: t.primary, width: 2) : null,
                  boxShadow: isToday
                      ? [
                          BoxShadow(
                              color: t.primary.withOpacity(0.2), blurRadius: 4)
                        ]
                      : null,
                ),
                child: Center(
    ...
    return FutureBuilder<SharedPreferences>(
      ...
      builder: (ctx, snap) {
        ...
        return Wrap(spacing: 8, runSpacing: 8, children: [
          for (int m = 1; m <= 12; m++)
            _buildMiniMonth(p, _viewYear, m, '$m', t,
  ...
  Widget _buildMiniMonth(SharedPreferences p, int year, int month, String label,
      WorkoutTheme t, bool isCurrent) {
    ...
    final total = history.values
        .fold<int>(0, (s, v) => s + (v is int ? v : int.tryParse('$v') ?? 0));
    return Container(
  ...
  List<Widget> _buildMiniGrid(
      int year, int month, Map<String, dynamic> history, WorkoutTheme t) {
    final daysInMonth = DateTime(year, month + 1, 0).day;
...
class NutritionPage extends StatelessWidget {
    ...
    return CustomScrollView(slivers: [
      ...
      SliverPadding(
          ...
          sliver: SliverList(
                    ...
                    return Wrap(
                      ...
                      children: [
                        ...
                        _macroStat(
                            ...
                            t,
                            itemWidth),
                        _macroStat('碳水', '200-270', 'g', Icons.grain_rounded,
                            t.warning, t, itemWidth),
                        _macroStat('脂肪', '58-73', 'g', Icons.water_drop_rounded,
                            t.accent, t, itemWidth),
                      ],
                    );
                  }),
                ))),
            ...
            FadeScaleEntry(
                index: 1,
                child: _mc('蛋白质', '130-160g', '1.8-2.2g/kg · 25%',
                    '鸡胸 · 牛肉 · 鸡蛋 · 鱼虾 · 豆腐 · 蛋白粉', t.primary, t)),
            const SizedBox(height: 8),
            FadeScaleEntry(
                index: 2,
                child: _mc('碳水', '200-270g', '2-3g/kg · 40%',
                    '糙米 · 红薯 · 燕麦 · 全麦 · 玉米 · 水果', t.warning, t)),
            const SizedBox(height: 8),
            FadeScaleEntry(
                index: 3,
                child: _mc('脂肪', '58-73g', '0.8-1g/kg · 30%',
                  ...
                  child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Expanded(
                              child: Text(nutritionTips[e.key],
                                  style: GoogleFonts.inter(
                                      fontSize: 12,
                                      color: t.text2,
                                      height: 1.6))),
  ...
  Widget _macroStat(String label, String value, String unit, IconData icon,
      Color color, WorkoutTheme t, double width) {
    return Container(
      width: width,
    ...
    return CustomScrollView(slivers: [
      ...
      SliverPadding(
          ...
          sliver: SliverList(
                ...
                child: Card(
                    ...
                    child: Padding(
                        ...
                        child: Text(
                            ...
                            style: GoogleFonts.inter(
                                fontSize: 12, color: t.text2, height: 1.7))))),
            const SizedBox(height: 16),
            FadeScaleEntry(
                index: 1,
                child: Text('四阶段计划',
            ...
            ].asMap().entries.map((i) => FadeScaleEntry(
                index: i.key + 8,
                child: Card(
                    margin: const EdgeInsets.only(bottom: 6),
                    child: ListTile(
                        dense: true,
                        title: Text(i.value.$1,
                            style: GoogleFonts.inter(
                                fontSize: 13,
                                fontWeight: FontWeight.w700,
                                color: t.text1)),
                        subtitle: Text(i.value.$2,
                            style: GoogleFonts.inter(
                                fontSize: 11, color: t.text3, height: 1.5)))))),
            const SizedBox(height: 8),
          ]))),
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < points.length; i++) {
      ...
      textPainter.text = TextSpan(
        ...
        style: GoogleFonts.inter(
            fontSize: 9, color: theme.text3, fontWeight: FontWeight.w600),
      );
      textPainter.layout();
      ...
      textPainter.paint(
          canvas,
          Offset(
              points[i].dx - textPainter.width / 2, padding.top + chartH + 6));
    }
  }
...
class MiniTrendChart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
        height: 180,
        child:
            CustomPaint(painter: TrendChartPainter(data: data, theme: theme)));
  }
}
...
class _SettingsPageState extends State<SettingsPage> {
    ...
    return Container(
      ...
      child: Padding(
          ...
          child:
            ...
            // 性别
            _profileTile(t, Icons.wc_rounded, '性别',
                p.gender == 'male' ? '👨 男' : '👩 女', () => _editGender(p)),
            const Divider(height: 1),
            // 身高
            _profileTile(t, Icons.height_rounded, '身高',
                '${p.heightCm.toInt()} cm', () => _editHeight(p)),
            const Divider(height: 1),
            // 体重
            _profileTile(t, Icons.monitor_weight_rounded, '当前体重',
                '${p.weightKg} kg', () => _editWeight(p)),
            const SizedBox(height: 12),
            // BMI 展示
            Container(
              decoration: BoxDecoration(
              ...
              child: Row(children: [
                Expanded(
                    child: Column(
                      ...
                      Text('BMI',
                          style:
                              GoogleFonts.inter(fontSize: 11, color: t.text3)),
                      Text(_bmiDisplay(p),
                          style: GoogleFonts.inter(
                              fontSize: 24,
                              fontWeight: FontWeight.w900,
  ...
  Widget _profileTile(WorkoutTheme t, IconData icon, String label, String value,
      VoidCallback onTap) {
    return PressScale(
        onTap: onTap,
        child: Padding(
        ...
        builder: (ctx) => AlertDialog(
              ...
              content: TextField(
                  ...
                  decoration: const InputDecoration(
                      hintText: 'YYYY-MM-DD', labelText: '生日日期')),
              actions: [
                TextButton(
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          const SizedBox(height: 10),
          if (isWeight) _weightTrendContent(t) else _measurementTrendContent(t),
        ]),
      ),
    );
  }
  ...
  Widget _weightTrendContent(WorkoutTheme t) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      if (weights.isNotEmpty) ...[
        Row(children: [
          Text('最新: ${weights.last.weightKg.toStringAsFixed(1)}kg',
    ...
    return Padding(
      ...
      child: Row(children: [
        ...
        Text('${entry.weightKg.toStringAsFixed(1)} kg',
            style: GoogleFonts.inter(
                fontSize: 11, color: t.text1, fontWeight: FontWeight.w700)),
        IconButton(
        ...
        IconButton(
            ...
            icon:
                Icon(Icons.delete_outline_rounded, size: 16, color: t.warning)),
      ]),
    );
  }
      ...
      if (waistData.length < 2)
        ...
        MiniTrendChart(
            data: waistData.length > 30
                ...
                : waistData,
            theme: t),
      ...entries.reversed.take(8).map((entry) => Padding(
            padding: const EdgeInsets.only(top: 8),
            child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
              SizedBox(
                  width: 76,
                  child: Text('${entry.date.month}/${entry.date.day}',
                      style: GoogleFonts.inter(fontSize: 11, color: t.text3))),
              Expanded(
                  child: Text(
  ...
  Future<void> _addWeightEntry({WeightEntry? existing}) async {
    ...
    if (result == null) return;
    final entries =
        await saveWeightEntry(WeightEntry(date: date, weightKg: result));
    if (!mounted) return;
            ...
            for (final field in fields.entries) ...[
              TextField(
                ...
                keyboardType:
                    const TextInputType.numberWithOptions(decimal: true),
                decoration:
                    InputDecoration(labelText: field.value, hintText: '可选'),
              ),
              const SizedBox(height: 6),
            ],
          ]),
  ...
  Future<void> _deleteMeasurement(BodyMeasurement entry) async {
    final confirmed =
        await _confirmDelete('删除 ${entry.date.month}/${entry.date.day} 的围度记录？');
    if (!confirmed) return;
    ...
    return Container(
      ...
      child: Padding(
          ...
          child:
            ...
            const SizedBox(height: 8),
            Text('JSON 格式 · 含资料、训练、体重与围度 · 导入前自动备份',
